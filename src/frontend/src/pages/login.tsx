...
const DEMO = [
  { role: "IT Employee",  name: "John Developer",       email: "employee@mavericks.com", password: "DemoPass!123" },
  { role: "Executive",    name: "Executive User",       email: "exec@mavericks.com",     password: "DemoPass!123" },
  { role: "IT Manager",   name: "Inventory Manager",    email: "manager@mavericks.com",  password: "DemoPass!123" },
  { role: "L2 Authority", name: "Management Authority", email: "l2@mavericks.com",       password: "DemoPass!123" },
  { role: "System Admin", name: "System Administrator", email: "admin@mavericks.com",    password: "DemoPass!123" },
];
